  ...
  return (
    <div className="glass-container p-0 hover:shadow-2xl transition-all duration-300 group relative overflow-hidden flex flex-col h-full">
      ...
      <div className="relative h-48 w-full overflow-hidden">
        {event.image_url ? (
          ...
          <div className="w-full h-full bg-gradient-to-br from-blue-900/40 via-slate-900 to-cyan-900/40 flex items-center justify-center">
            <span className="text-white/20 font-black text-4xl uppercase tracking-tighter italic">
              ClubHub
            </span>
          </div>
        )}
      ...
      <div className="p-6 flex flex-col flex-1 relative">
        ...
        <h2 className="text-2xl font-black mb-3 text-white group-hover:text-blue-300 transition-colors">
          {event.title}
        </h2>

        <p className="text-blue-100/60 mb-4 line-clamp-2 text-sm font-light leading-relaxed">
          {event.description}
        </p>
